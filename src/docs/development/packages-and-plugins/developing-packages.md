...
If no platforms are specified, a plugin project no platforms will be created.
...
```
```terminal
$ flutter create --org com.example --template=plugin --platforms=ios -i objc hello
```
```terminal
$ flutter create --org com.example --template=plugin --platforms=ios -i swift hello
```
